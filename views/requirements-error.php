...
<?php else : ?>
	<ul class="ul-disc">
		...
		<li>
			...
			<em><?php if ( is_wpml_active() ) printf( __( '(You\'re running version %s)', 'wpml-trailers' ), WPML_VERSION ); ?></em>
		</li>
	</ul>
