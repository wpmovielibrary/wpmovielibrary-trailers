...
<?php if ( ! is_plugin_active( 'wpmovielibrary/wpmovielibrary.php' ) ) : ?>
	<ul class="ul-disc">
...
<?php else : ?>
	<ul class="ul-disc">
		<li>
			<strong style="color:<?php echo $wp; ?>;">PHP <?php echo WPMLTR_REQUIRED_PHP_VERSION; ?>+</strong>
			<em><?php printf( __( '(You\'re running version %s)', 'wpml-trailers' ), PHP_VERSION ); ?></em>
		</li>
		<li>
			<strong style="color:<?php echo $php; ?>;">WordPress <?php echo WPMLTR_REQUIRED_WP_VERSION; ?>+</strong>
			<em><?php printf( __( '(You\'re running version %s)', 'wpml-trailers' ), esc_html( $wp_version ) ); ?></em>
		</li>
		<li>
			<strong style="color:<?php echo $wpml; ?>;">WPMovieLibrary <?php echo WPMLTR_REQUIRED_WPML_VERSION; ?>+</strong>
